...
@section('title', 'Edit UMKM - Admin Nagari Silungkang Oso')
            ...
            <form action="{{ route('admin.umkm.update', $umkm) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="card-body space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name"
                                            value="{{ old('name', $umkm->name) }}" class="form-input w-full" required>
                                        @error('name')
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="owner" name="owner"
                                            value="{{ old('owner', $umkm->owner) }}" class="form-input w-full" required>
                                        @error('owner')
                                            <p class="form-error">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select id="category" name="category" class="form-select w-full" required>
                                            ...
                                            <option value="Kerajinan"
                                                {{ old('category', $umkm->category) == 'Kerajinan' ? 'selected' : '' }}>
                                                Kerajinan</option>
                                            <option value="Kuliner"
                                                {{ old('category', $umkm->category) == 'Kuliner' ? 'selected' : '' }}>
                                                Kuliner</option>
                                            <option value="Fashion"
                                                {{ old('category', $umkm->category) == 'Fashion' ? 'selected' : '' }}>
                                                Fashion</option>
                                            <option value="Pertanian"
                                                {{ old('category', $umkm->category) == 'Pertanian' ? 'selected' : '' }}>
                                                Pertanian</option>
                                            <option value="Jasa"
                                                {{ old('category', $umkm->category) == 'Jasa' ? 'selected' : '' }}>Jasa
                                            </option>
                                            <option value="Perdagangan"
                                                {{ old('category', $umkm->category) == 'Perdagangan' ? 'selected' : '' }}>
                                                Perdagangan</option>
                                        </select>
                                        @error('category')
                                            <p class="form-error">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="phone" name="phone"
                                            value="{{ old('phone', $umkm->phone) }}" class="form-input w-full"
                                ...
                                <div>
                                    <label for="address" class="form-label">Alamat <span
                                            class="text-red-500">*</span></label>
                                    <textarea id="address" name="address" rows="2" class="form-textarea w-full" required>{{ old('address', $umkm->address) }}</textarea>
                                    @error('address')
                                        <p class="form-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <label for="description" class="form-label">Deskripsi <span
                                            class="text-red-500">*</span></label>
                                    <textarea id="description" name="description" rows="4" class="form-textarea w-full" required>{{ old('description', $umkm->description) }}</textarea>
                                    @error('description')
                                        <p class="form-error">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="font-semibold text-gray-900">{{ $umkm->image ? 'Ganti Foto' : 'Upload Foto' }}
                                </h3>
                                @if ($umkm->image)
