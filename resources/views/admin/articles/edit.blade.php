...
@section('title', 'Edit Artikel - Admin Nagari Silungkang Oso')
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="text" id="title" name="title"
                                    value="{{ old('title', $article->title) }}" class="form-input w-full" required>
                                @error('title')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <label for="excerpt" class="form-label">Ringkasan <span
                                        class="text-red-500">*</span></label>
                                <textarea id="excerpt" name="excerpt" rows="3" class="form-textarea w-full" required>{{ old('excerpt', $article->excerpt) }}</textarea>
                                @error('excerpt')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <label for="content" class="form-label">Konten Artikel <span
                                        class="text-red-500">*</span></label>
                                <textarea id="content" name="content" rows="15" class="form-textarea w-full" required>{{ old('content', $article->content) }}</textarea>
                                @error('content')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="flex items-center">
                                    ...
                                    <label for="is_published" class="ml-2 text-sm text-gray-700">Publikasikan
                                        artikel</label>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($article->featured_image)
                                    <div class="mb-4">
                                        <img src="{{ Storage::url($article->featured_image) }}" alt="Current image"
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="featured_image"
                                                ...
                                                <span>{{ $article->featured_image ? 'Ganti gambar' : 'Upload gambar' }}</span>
