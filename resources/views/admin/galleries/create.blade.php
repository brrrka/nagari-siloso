...
@section('title', 'Tambah Foto - Admin Nagari Silungkang Oso')
    ...
    <div class="min-h-screen bg-gray-100">
        <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Tambah Foto ke Galeri</h1>
            </div>
                            ...
                            <div class="card-body space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="4" class="form-textarea w-full"
                                        placeholder="Tulis deskripsi foto...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="form-error">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div>
                        ...
                        <div class="card mb-6">
                            <div class="card-header">
                                <h3 class="font-semibold text-gray-900">Upload Foto</h3>
                            </div>
                            <div class="card-body">
                                <div
