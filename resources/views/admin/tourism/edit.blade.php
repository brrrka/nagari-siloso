...
@section('title', 'Edit Wisata - Admin Nagari Silungkang Oso')
    ...
    <div class="min-h-screen bg-gray-100">
        <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Edit Destinasi Wisata</h1>
            </div>
                            ...
                            <div class="card-body space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name"
                                        value="{{ old('name', $tourism->name) }}" class="form-input w-full" required>
                                    @error('name')
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select id="category" name="category" class="form-select w-full" required>
                                            ...
                                            <option value="Alam"
                                                {{ old('category', $tourism->category) == 'Alam' ? 'selected' : '' }}>Alam
                                            </option>
                                            <option value="Budaya"
                                                {{ old('category', $tourism->category) == 'Budaya' ? 'selected' : '' }}>
                                                Budaya</option>
                                            <option value="Sejarah"
                                                {{ old('category', $tourism->category) == 'Sejarah' ? 'selected' : '' }}>
                                                Sejarah</option>
                                            <option value="Religi"
                                                {{ old('category', $tourism->category) == 'Religi' ? 'selected' : '' }}>
                                                Religi</option>
                                            <option value="Kuliner"
                                                {{ old('category', $tourism->category) == 'Kuliner' ? 'selected' : '' }}>
                                                Kuliner</option>
                                            <option value="Petualangan"
                                                {{ old('category', $tourism->category) == 'Petualangan' ? 'selected' : '' }}>
                                                Petualangan</option>
                                        </select>
                                        @error('category')
                                            <p class="form-error">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="location" name="location"
                                            value="{{ old('location', $tourism->location) }}" class="form-input w-full"
                                            required placeholder="Contoh: Jorong Koto Baru">
                                        @error('location')
                                            <p class="form-error">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    <label for="description" class="form-label">Deskripsi <span
                                            class="text-red-500">*</span></label>
                                    <textarea id="description" name="description" rows="5" class="form-textarea w-full" required>{{ old('description', $tourism->description) }}</textarea>
                                    @error('description')
                                        <p class="form-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number" step="any" id="latitude" name="latitude"
                                            value="{{ old('latitude', $tourism->latitude) }}" class="form-input w-full"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="any" id="longitude" name="longitude"
                                            value="{{ old('longitude', $tourism->longitude) }}" class="form-input w-full"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="font-semibold text-gray-900">
                                    {{ $tourism->image ? 'Ganti Foto' : 'Upload Foto' }}</h3>
                                @if ($tourism->image)
